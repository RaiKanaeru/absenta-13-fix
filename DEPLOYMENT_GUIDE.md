...
# Run migration for KOP Laporan
node setup-kop-laporan.js

# Verify database
mysql -u root -p -e "USE absenta113; SHOW TABLES;"
```

### 4. Setup Logo Laporan
```bash
# Pastikan direktori logo sudah ada
mkdir -p public/uploads/letterheads

# Upload logo resmi (opsional - sudah tersedia default)
# Logo Jawa Barat: public/uploads/letterheads/logo-jawa-barat.png
# Logo SMK: public/uploads/letterheads/logo-smk.png

# Verifikasi logo tersedia
ls -la public/uploads/letterheads/
```
