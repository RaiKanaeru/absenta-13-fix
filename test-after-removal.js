// Test System After Table Removal
import 'dotenv/config';

const testAfterRemoval = async () => {
    try {
        console.log('🧪 Testing system after table removal...\n');
        ...
        try {
            const studentData = {
                username: 'test_student_removal',
                nis: 'TEST002',
                nama: 'Test Student Removal',
                kelas_id: 349,
        ...
        console.log('✅ Table removal was successful and system is functional');
