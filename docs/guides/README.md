...
### 📄 Laporan Features
- 📋 **KOP Laporan Resmi**: Logo Provinsi Jawa Barat dan SMK di semua laporan
- 🎨 **Letterhead Customizable**: Konfigurasi header laporan per jenis laporan
- 📊 **Excel Export**: Ekspor laporan dengan format resmi sekolah
- 🖨️ **Print Ready**: Laporan siap cetak dengan kualitas tinggi
