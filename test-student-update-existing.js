// Test Student Update with Existing Data
import 'dotenv/config';

const testStudentUpdateExisting = async () => {
    try {
        console.log('🧪 Testing student update with existing data...\n');
