...
async function testAttendanceFixed() {
    console.log('🧪 Testing Attendance Aggregation (Fixed)...');
    ...
    try {
        ...
        console.log(`\n📊 Results:`);
        console.log(`  Student 1 (SAKIT + HADIR): ${student1Result?.final_status} (should be HADIR)`);
        console.log(`  Student 2 (ALPHA + HADIR): ${student2Result?.final_status} (should be TIDAK_HADIR)`);
        ...
        console.log(`\n📊 DISPEN Test:`);
        console.log(`  Student 1 (DISPEN + DISPEN): ${dispenStudent1?.final_status} (should be HADIR)`);
...
testAttendanceFixed().catch(console.error);
